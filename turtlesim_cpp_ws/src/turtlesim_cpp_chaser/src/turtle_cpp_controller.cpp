...
{
public:
    TurtleControllerNode() : Node("turtle_cpp_controller"), name_("turtle1"), turtlesim_up_(false)
    {
        ...
        turtles_to_catch_subscriber_ = this->create_subscription<turtlesim_cpp_interfaces::msg::TurtleArray>(
...
private:
    ...
    double getDistanceFromCurrentPose(turtlesim_cpp_interfaces::msg::Turtle turtle)
    {
    ...
    void callbackTurtlesToCatch(const turtlesim_cpp_interfaces::msg::TurtleArray::SharedPtr msg)
    {
        if (!msg->turtles.empty())
        {
            if (catch_closest_turtle_first_)
            {
                turtlesim_cpp_interfaces::msg::Turtle closest_turtle = msg->turtles.at(0);
    ...
    {
        auto client = this->create_client<turtlesim_cpp_interfaces::srv::CatchTurtle>("catch_turtle");
        while (!client->wait_for_service(std::chrono::seconds(1)))
        {
            RCLCPP_WARN(this->get_logger(), "Waiting for Service Server to be up...");
        }

        auto request = std::make_shared<turtlesim_cpp_interfaces::srv::CatchTurtle::Request>();
    ...
    turtlesim_cpp_interfaces::msg::Turtle turtle_to_catch_;

    rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr cmd_vel_publisher_;
    rclcpp::Subscription<turtlesim::msg::Pose>::SharedPtr pose_subscriber_;
    rclcpp::Subscription<turtlesim_cpp_interfaces::msg::TurtleArray>::SharedPtr turtles_to_catch_subscriber_;
