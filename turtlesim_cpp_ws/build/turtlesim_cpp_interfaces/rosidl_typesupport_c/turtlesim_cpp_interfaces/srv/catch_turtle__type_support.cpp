...
#include "turtlesim_cpp_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _CatchTurtle_Request_type_support_symbol_names_t _CatchTurtle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_cpp_interfaces, srv, CatchTurtle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_cpp_interfaces, srv, CatchTurtle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_turtlesim_cpp_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_cpp_interfaces, srv, CatchTurtle_Request)() {
  return &::turtlesim_cpp_interfaces::srv::rosidl_typesupport_c::CatchTurtle_Request_message_type_support_handle;
}
...
static const _CatchTurtle_Response_type_support_symbol_names_t _CatchTurtle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_cpp_interfaces, srv, CatchTurtle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_cpp_interfaces, srv, CatchTurtle_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_turtlesim_cpp_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_cpp_interfaces, srv, CatchTurtle_Response)() {
  return &::turtlesim_cpp_interfaces::srv::rosidl_typesupport_c::CatchTurtle_Response_message_type_support_handle;
}
...
static const _CatchTurtle_type_support_symbol_names_t _CatchTurtle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlesim_cpp_interfaces, srv, CatchTurtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlesim_cpp_interfaces, srv, CatchTurtle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtlesim_cpp_interfaces, srv, CatchTurtle)() {
  return &::turtlesim_cpp_interfaces::srv::rosidl_typesupport_c::CatchTurtle_service_type_support_handle;
}
